...
export default function BillingSettingsPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-4 inline-flex items-center rounded-full bg-primary-50 px-3 py-1 text-sm font-medium text-primary-700 dark:bg-primary-900/20 dark:text-primary-300">
        Current plan: {PLAN_DISPLAY[currentPlan]?.name || "Free"}
      </div>
